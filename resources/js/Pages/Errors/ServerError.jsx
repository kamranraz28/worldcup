            ...
            <div className="min-h-screen bg-neutral-50 dark:bg-dark-bg flex items-center justify-center px-4">
                <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden="true">
                    <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2
                        w-[700px] h-[700px] bg-amber-500/[0.04] rounded-full blur-[150px]" />
                ...
                >
                    <motion.div
                        ...
                        className="w-24 h-24 rounded-3xl bg-gradient-to-br from-amber-500/10 to-amber-500/5 
                            border border-amber-500/20 flex items-center justify-center mx-auto mb-8"
                    >
                    ...
                    <motion.h1
                        ...
                        className="text-7xl font-extrabold tracking-tight bg-gradient-to-r from-amber-500 to-amber-400 bg-clip-text text-transparent mb-3">
                        500
                    </motion.h1>
                    <motion.p
                        initial={{ opacity: 0 }}
