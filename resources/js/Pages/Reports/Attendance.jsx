...
export default function AttendanceReport({ report, filters, events }) {
  ...
  useEffect(() => {
    ...
    window.location.href = appUrl(`/reports/attendance?${params.toString()}`);
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <a href={appUrl(`/reports/export/attendance/csv${window.location.search}`)} className="btn-secondary h-10 px-4 text-sm">Export CSV</a>
            <a href={appUrl(`/reports/export/attendance/pdf${window.location.search}`)} className="btn-secondary h-10 px-4 text-sm">Export PDF</a>
