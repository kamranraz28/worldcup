  ...
  return (
    <AppLayout>
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Link href={appUrl("/reports/registration")} className="group glass-card p-5 hover:bg-white/[0.06] transition-all">
          ...
          <Link href={appUrl("/reports/attendance")} className="group glass-card p-5 hover:bg-white/[0.06] transition-all">
